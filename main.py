...
async def on_message(message):
    ...
    if message.content == f"{prefix}녹티스 기술표":
        ...
        embed.add_field(name="26", value="1lk", inline=False)
        embed.add_field(name="27", value="1rk", inline=False)
        embed.add_field(name="28", value="오라", inline=False)
        embed.add_field(name="29", value="4lp rp", inline=False)
        embed.add_field(name="30", value="4rp", inline=False)
        embed.add_field(name="31", value="가불기", inline=False)
        embed.add_field(name="32", value="퀵칼", inline=False)
        embed.add_field(name="33", value="컷니", inline=False)
        embed.add_field(name="34", value="66rk", inline=False)
        embed.add_field(name="35", value="시져스", inline=False)
        embed.add_field(name="36", value="공참칼", inline=False)
        embed.add_field(name="37", value="기상칼(기상 lp rp)", inline=False)
        embed.add_field(name="38", value="기상 lk rp", inline=False)
        embed.add_field(name="39", value="기상어퍼", inline=False)
        embed.add_field(name="40", value="앉아방패", inline=False)
        embed.add_field(name="41", value="연칼", inline=False)
        embed.add_field(name="42", value="횡 rp", inline=False)
        embed.add_field(name="43", value="4rk ap", inline=False)
        embed.add_field(name="44", value="4lk lp", inline=False)
