...
async def on_message(message):
    ...
    if message.content == f"{prefix}봇 사용법" or message.content == f"{prefix}도움":
        ...
        embed.add_field(name="등록된 캐릭터", value="녹티스, 카즈야, 샤힌, 폴, 클라우디오, 네간, 머독, 리로이, 데빌진, 안나, 로우, 아머킹, 브라이언", inline=False)
        embed.add_field(name="* 중요 *", value="봇으로 기술이름을 검색하여 나오지않을경우 커맨드로 입력하시고 멘션해주시면 바로 수정하겠습니다 만약 기술이 아예없을경우 빠른 시일 내에 추가하겠니다", inline=False)
    ...
    if message.content == f"{prefix}녹티스 rp" or message.content == f"{prefix}블리츠 러쉬":
        ...
        embed.add_field(name="추가타", value="히트시 하단창[1rp]확정", inline=False)
    ...
    if message.content == f"{prefix}녹티스 파크":
        ...
        embed.add_field(name="가드시", value=" -13", inline=False)
        embed.add_field(name="추가타", value="히트시 중단창[6ap]확정", inline=False)
    ...
    if message.content == f"{prefix}녹티스 4lp rp":
        ...
        embed.add_field(name="판정", value="상단", inline=False)
        embed.add_field(name="가드시", value=" -9", inline=False)
        embed.add_field(name="추가타", value="2타 카운터시 콤보", inline=False)
    ...
    if message.content == f"{prefix}녹티스 4rp":
        ...
        embed.add_field(name="판정", value="중단", inline=False)
        embed.add_field(name="가드시", value=" -9", inline=False)
        embed.add_field(name="추가타", value="히트시 ap", inline=False)
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}퀵칼":
        ...
        embed.add_field(name="추가타", value="카운터시 콤보", inline=False)
    ...
    if message.content == f"{prefix}녹티스 횡 rp":
        ...
        embed.add_field(name="추가타", value="카운터시 오라[1ap]확정", inline=False)
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}녹티스 기술표":
        ...
        embed.add_field(name="2", value="원투양손", inline=True)
        embed.add_field(name="3", value="블리츠 러쉬(rp)", inline=True)
        embed.add_field(name="4", value="투투 중단", inline=True)
    ...
    if message.content == f"{prefix}녹티스 기술표2":
        ...
        embed.add_field(name="29", value="4lp rp", inline=True)
        embed.add_field(name="30", value="4rp", inline=True)
        embed.add_field(name="31", value="가불기", inline=True)
        embed.add_field(name="32", value="퀵칼", inline=True)
        embed.add_field(name="33", value="컷니", inline=True)
        embed.add_field(name="34", value="66rk", inline=True)
        embed.add_field(name="35", value="시져스", inline=True)
        embed.add_field(name="36", value="공참칼", inline=True)
        embed.add_field(name="37", value="기상칼(기상 lp rp)", inline=True)
        embed.add_field(name="38", value="기상 lk rp", inline=True)
        embed.add_field(name="39", value="기상어퍼", inline=True)
        embed.add_field(name="40", value="앉아방패", inline=True)
        embed.add_field(name="41", value="연칼", inline=True)
        embed.add_field(name="42", value="횡 rp", inline=True)
        embed.add_field(name="43", value="4rk ap", inline=True)
        embed.add_field(name="44", value="4lk lp", inline=True)
        embed.add_field(name="45", value="뒤자세 rp", inline=True)
        embed.add_field(name="46", value="9rk", inline=True)
        embed.add_field(name="47", value="레드", inline=True)
        embed.add_field(name="48", value="패링", inline=True)
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}카즈야 원투투" :
        ...
        embed.add_field(name="판정", value="상단", inline=False)
        embed.add_field(name="가드시", value=" -12", inline=False)
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884418347683442698/ezgif.com-gif-maker_40.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}카즈야 원투포쓰리":
        ...
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884418363231731742/ezgif.com-gif-maker_41.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}카즈야 데몬 시져스" or message.content == f"{prefix}카즈야 rklk":
        embed = discord.Embed(title="demon sicssors", description = "[rk lk]", color=0x009bcf)
        embed.add_field(name="프레임", value="31", inline=True)
        embed.add_field(name="판정", value="중단", inline=False)
        embed.add_field(name="가드시", value=" -10", inline=False)
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884418285834240020/ezgif.com-gif-maker_18.gif")
        await message.channel.send(embed=embed)
        
    if message.content == f"{prefix}카즈야 ap":
        embed = discord.Embed(title="acute pain", description = "ap", color=0x009bcf)
        embed.add_field(name="프레임", value="12", inline=True)
        embed.add_field(name="판정", value="중단", inline=False)
        embed.add_field(name="가드시", value=" -13", inline=False)
        embed.set_image(url="https://media.discordapp.net/attachments/865482695256440843/884418261192683550/ezgif.com-gif-maker_11.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}카즈야 6ap":
    ...
    if message.content == f"{prefix}카즈야 우종":
        embed = discord.Embed(title="right splits kick", description = "6rk", color=0x009bcf)
        embed.add_field(name="프레임", value="19", inline=True)
        embed.add_field(name="판정", value="중단", inline=False)
        embed.add_field(name="가드시", value=" +4", inline=False)
        embed.add_field(name="추가타", value="카운터시 뻥발[66rk]확정", inline=False)
    ...
    if message.content == f"{prefix}카즈야 왼어퍼포":
        ...
        embed.add_field(name="판정", value="중상", inline=False)
        embed.add_field(name="가드시", value=" -3", inline=False)
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884418349080129536/ezgif.com-gif-maker_38.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}카즈야 3lp 6rp":
        ...
        embed.add_field(name="판정", value="중단", inline=False)
        embed.add_field(name="가드시", value=" -12", inline=False)
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884418223221661706/ezgif.com-gif-maker_2.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}사자":
        ...
        embed.add_field(name="판정", value="중단", inline=False)
        embed.add_field(name="가드시", value=" -9", inline=False)
        embed.add_field(name="추가타", value="히트시 뻥발[66rk]확정", inline=False)
    ...
    if message.content == f"{prefix}카즈야 3rk rk" :
        embed = discord.Embed(title="tsuanmi kick", description = "3rk rk", color=0x009bcf)
    ...
    if message.content == f"{prefix}퇴쇄":
        ...
        embed.add_field(name="판정", value="하단", inline=False)
        embed.add_field(name="가드시", value=" -11", inline=False)
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884418207727878184/ezgif.com-gif-maker_45.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}카즈야 4lp rp":
        ...
        embed.add_field(name="판정", value="상중", inline=False)
        embed.add_field(name="가드시", value=" -14", inline=False)
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884418258306998272/ezgif.com-gif-maker_5.gif")
        await message.channel.send(embed=embed)

    if message.content == f"{prefix}카즈야 몸지랄 중단":
        embed = discord.Embed(title="demon's wrath", description = "4lk lp rk lp", color=0x009bcf)
        embed.add_field(name="프레임", value="18", inline=True)
        embed.add_field(name="판정", value="상상하중", inline=False)
        embed.add_field(name="가드시", value=" -14", inline=False)
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884418369611251712/ezgif.com-gif-maker_30.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}카즈야 몸지랄 하단":
        ...
        embed.add_field(name="가드시", value=" -13", inline=False)
        embed.set_image(url="https://media.discordapp.net/attachments/865482695256440843/884418351013691392/ezgif.com-gif-maker_31.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}카즈야 4rp lp":
        embed = discord.Embed(title="rampaging demon to left hook", description = "4rp lp", color=0x009bcf)
        embed.add_field(name="프레임", value="14", inline=True)
        embed.add_field(name="판정", value="중단", inline=False)
        embed.add_field(name="가드시", value=" -14(2타)", inline=False)
        embed.set_image(url="https://media.discordapp.net/attachments/865482695256440843/884418266829819904/ezgif.com-gif-maker_6.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}카즈야 9lk":
        embed = discord.Embed(title="searing edge", description = "9lk", color=0x009bcf)
        embed.add_field(name="프레임", value="19", inline=True)
        embed.add_field(name="판정", value="중단", inline=False)
        embed.add_field(name="가드시", value="-9", inline=False)
        embed.set_image(url="https://media.discordapp.net/attachments/865482695256440843/884418276187328542/ezgif.com-gif-maker_9.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}중단나락":
        ...
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884420048456929290/ezgif.com-gif-maker_43.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}좌종":
        ...
        embed.add_field(name="판정", value="중단", inline=False)
        embed.add_field(name="가드시", value=" -4", inline=False)
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884418368172589076/ezgif.com-gif-maker_42.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}카즈야 뻥발":
        ...
        embed.add_field(name="가드시", value=" -9", inline=False)
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884418405657112646/ezgif.com-gif-maker_33.gif")
        await message.channel.send(embed=embed)
        
    if message.content == f"{prefix}카즈야 66rp":
        embed = discord.Embed(title="zankyosho", description = "66rp", color=0x009bcf)
        embed.add_field(name="프레임", value="13", inline=True)
        embed.add_field(name="판정", value="상단", inline=False)
        embed.add_field(name="가드시", value=" -11", inline=False)
    ...
    if message.content == f"{prefix}데빌 피스트":
        ...
        embed.add_field(name="판정", value="중단", inline=False)
        embed.add_field(name="가드시", value=" -12", inline=False)
        embed.set_image(url="https://media.discordapp.net/attachments/865482695256440843/884419309567352882/ezgif.com-gif-maker_21.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}뇌신권":
        ...
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884419199458508820/ezgif.com-gif-maker_17.gif")
        await message.channel.send(embed=embed)
        
    if message.content == f"{prefix}신달킥":
        embed = discord.Embed(title="hell lancer", description = "6n23lk", color=0x009bcf)
        embed.add_field(name="프레임", value="18", inline=True)
        embed.add_field(name="판정", value="상단", inline=False)
        embed.add_field(name="가드시", value=" -9", inline=False)
        embed.set_image(url="https://media.discordapp.net/attachments/865482695256440843/884418372031381534/ezgif.com-gif-maker_36.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}초풍":
        ...
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884420076378402826/ezgif.com-gif-maker_44.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}카즈야 나락":
        ...
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884418326279901204/ezgif.com-gif-maker_16.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}카즈야 떠퍼" or message.content == f"{prefix}카즈야 기상lp rp":
        ...
        embed.add_field(name="판정", value="중단", inline=False)
        embed.add_field(name="가드시", value=" -12", inline=False)
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884418360027275284/ezgif.com-gif-maker_23.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}마신권"  or message.content == f"{prefix}카즈야 기상rp":
        ...
        embed.add_field(name="판정", value="중단", inline=False)
        embed.add_field(name="가드시", value=" -16", inline=False)
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884419786061275166/ezgif.com-gif-maker_29.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}카즈야 기상킥" :
        ...
        embed.add_field(name="판정", value="중단", inline=False)
        embed.add_field(name="가드시", value=" -15(2타)", inline=False)
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884418293358809098/ezgif.com-gif-maker_14.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}창 밖을 봐라"  or message.content == f"{prefix}카즈야 기상ap":
        ...
        embed.add_field(name="가드시", value=" -9", inline=False)
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884779687480533032/ap.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}카즈야 레이져" :
        ...
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884419576958435348/ezgif.com-gif-maker_25.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}카즈야 레이져2" :
        ...
        embed.add_field(name="프레임", value="69", inline=True)
        embed.add_field(name="판정", value="가불기", inline=False)
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884419608302469130/ezgif.com-gif-maker_26.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}카즈야 레이져3" :
        ...
        embed.add_field(name="판정", value="가불기", inline=False)
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884418406667919360/ezgif.com-gif-maker_27.gif")
        await message.channel.send(embed=embed)
        
    if message.content == f"{prefix}카즈야 레이져4" :
        embed = discord.Embed(title="reverse devil blaster", description = "데빌 상태에서 9ap", color=0x009bcf)
        embed.set_image(url="https://media.discordapp.net/attachments/865482695256440843/884418362703220806/ezgif.com-gif-maker_28.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}데빌카즈야 떠퍼" :
        ...
        embed.add_field(name="판정", value="중단", inline=False)
        embed.add_field(name="가드시", value=" -13", inline=False)
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884418377202941952/ezgif.com-gif-maker_19.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}카즈야 데빌 트위스터" :
        ...
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884418377177780224/ezgif.com-gif-maker_20.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}카즈야 레드":
        ...
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884419389082992650/ezgif.com-gif-maker_24.gif")
        await message.channel.send(embed=embed)
        
    if message.content == f"{prefix}카즈야 기술표":
        embed = discord.Embed(title="기술목록", description = "", color=0x009bcf)
        embed.add_field(name="1", value="섬광", inline=True)
        embed.add_field(name="2", value="원투투", inline=True)
        embed.add_field(name="3", value="원투포쓰리", inline=True)
        embed.add_field(name="4", value="쓰리원포", inline=True)
        embed.add_field(name="5", value="데몬 시져스", inline=True)
        embed.add_field(name="6", value="ap", inline=True)
        embed.add_field(name="7", value="파크", inline=True)
        embed.add_field(name="8", value="6ap", inline=True)
        embed.add_field(name="9", value="6lk", inline=True)
        embed.add_field(name="10", value="우종", inline=True)
        embed.add_field(name="11", value="왼어퍼 투", inline=True)
        embed.add_field(name="12", value="왼어퍼 포", inline=True)
        embed.add_field(name="13", value="3lp 6rp", inline=True)
        embed.add_field(name="14", value="기원권", inline=True)
        embed.add_field(name="15", value="사자", inline=True)
        embed.add_field(name="16", value="3rk rk", inline=True)
        embed.add_field(name="17", value="1lk", inline=True)
        embed.add_field(name="18", value="퇴쇠", inline=True)
        embed.add_field(name="19", value="2ap", inline=True)
        embed.add_field(name="20", value="4lp rp", inline=True)
        embed.add_field(name="21", value="2lp", inline=True)
        embed.add_field(name="22", value="2rp rp", inline=True)
        embed.add_field(name="23", value="몸지랄 중단", inline=True)
        embed.add_field(name="24", value="몸지랄 하단", inline=True)
        embed.add_field(name="25", value="4rk", inline=True)
        await message.channel.send(embed=embed)
        
    if message.content == f"{prefix}카즈야 기술표2":
        embed = discord.Embed(title="기술목록", description = "", color=0x009bcf)
    ...
    if message.content == f"{prefix}폴 헤머링":
        ...
        embed.add_field(name="판정", value="중단", inline=False)
        embed.add_field(name="가드시", value="+3", inline=False)
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884793018744463370/ezgif.com-gif-maker_38.gif")
        await message.channel.send(embed=embed)
        
    if message.content == f"{prefix}폴 진군":
        embed = discord.Embed(title="pison fire ", description = "lk rp (4입력시 스웨이 이행)", color=0x009bcf)
        embed.add_field(name="프레임", value="17", inline=True)
        embed.add_field(name="판정", value="중상", inline=False)
        embed.add_field(name="가드시", value="-3 +4(스웨이 이행시)", inline=False)
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884790932938059866/ezgif.com-gif-maker_34.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}폴 6rplk":
        ...
        embed.add_field(name="판정", value="중단", inline=False)
        embed.add_field(name="가드시", value="-14", inline=False)
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884796422438936576/ezgif.com-gif-maker_2.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}폴 3lp lp rp":
        ...
        embed.add_field(name="판정", value="중상중", inline=False)
        embed.add_field(name="가드시", value="-5", inline=False)
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884788996528566312/ezgif.com-gif-maker_2.gif")
        await message.channel.send(embed=embed)

    if message.content == f"{prefix}폴 왼어퍼":
        embed = discord.Embed(title="body blow tp sway" , description = "3lp(4입력으로 스웨이 이행)", color=0x009bcf)
        embed.add_field(name="프레임", value="14", inline=True)
        embed.add_field(name="판정", value="중단", inline=False)
        embed.add_field(name="가드시", value="-2 +3(스웨이 이행시)", inline=False)
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884790775395807262/ezgif.com-gif-maker_30.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}기와":
        ...
        embed.add_field(name="판정", value="중단", inline=False)
        embed.add_field(name="가드시", value="-9", inline=False)
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884790137849016330/ezgif.com-gif-maker_15.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}기와 붕권":
        ...
        embed.add_field(name="프레임", value="14", inline=True)
        embed.add_field(name="판정", value="중단", inline=False)
        embed.add_field(name="가드시", value="-17(2타,홀드시+20가드백)", inline=False)
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884790116248338432/ezgif.com-gif-maker_14.gif")
        await message.channel.send(embed=embed)

    if message.content == f"{prefix}기와 낙엽":
        embed = discord.Embed(title="hang over" , description = "2lp rk", color=0x009bcf)
        embed.add_field(name="프레임", value="14", inline=True)
        embed.add_field(name="판정", value="중하중", inline=False)
        embed.add_field(name="가드시", value="-31(2타)", inline=False)
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884790073365786674/ezgif.com-gif-maker_13.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}벽력장":
        ...
        embed.add_field(name="가드시", value="-31(1타) -18(2타) -17(3타,가드백)", inline=False)
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884790491286208522/ezgif.com-gif-maker_21.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}철산고":
        ...
        embed.add_field(name="판정", value="중단", inline=False)
        embed.add_field(name="가드시", value="-16", inline=False)
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884790956820426772/ezgif.com-gif-maker_35.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}폴 1rp":
        ...
        embed.add_field(name="판정", value="중단", inline=False)
        embed.add_field(name="가드시", value="-11", inline=False)
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884793070523134032/ezgif.com-gif-maker.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}쌍부":
        ...
        embed.add_field(name="판정", value="상단(호밍기)", inline=False)
        embed.add_field(name="가드시", value="-5", inline=False)
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884790659230355496/ezgif.com-gif-maker_26.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}폴 뒷무릎" or message. content == f"{prefix}폴 4lk":
        ...
        embed.add_field(name="판정", value="중단", inline=False)
        embed.add_field(name="가드시", value="-6", inline=False)
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884790165669810186/ezgif.com-gif-maker_16.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}폴 4rk":
        ...
        embed.add_field(name="판정", value="하단", inline=False)
        embed.add_field(name="가드시", value="-13", inline=False)
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884789051520069714/ezgif.com-gif-maker_4.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}폴 파크":
        ...
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884789028342362122/ezgif.com-gif-maker_3.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}쌍비":
        ...
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884790689429344266/ezgif.com-gif-maker_27.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}용포 중단":
        ...
        embed.add_field(name="판정", value="중단", inline=False)
        embed.add_field(name="가드시", value="-12", inline=False)
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884790859080556554/ezgif.com-gif-maker_32.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}용포 저스트":
        ...
        embed.add_field(name="판정", value="중상", inline=False)
        embed.add_field(name="가드시", value="-4(가드백 있음)", inline=False)
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884790807058608218/ezgif.com-gif-maker_31.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}용포 하단":
        ...
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884790892450435102/ezgif.com-gif-maker_33.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}폴 66rk":
        ...
        embed.add_field(name="판정", value="중단", inline=False)
        embed.add_field(name="가드시", value="-1", inline=False)
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884789319900991508/66rk.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}폴 가불기":
        ...
        embed.add_field(name="프레임", value="63", inline=True)
        embed.add_field(name="판정", value="가불기", inline=False)
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884790058928975983/ezgif.com-gif-maker_12.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}붕권":
        ...
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884790563168219156/ezgif.com-gif-maker_23.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}발산":
        ...
        embed.add_field(name="판정", value="중단", inline=False)
        embed.add_field(name="가드시", value="-9", inline=False)
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884790266563817512/ezgif.com-gif-maker_19.gif")
        await message.channel.send(embed=embed)
        
    if message.content == f"{prefix}폴 214lp":
    ...
    if message.content == f"{prefix}폴 214lk":
    ...
    if message.content == f"{prefix}폴 214lk rp lp":
    ...
    if message.content == f"{prefix}폴 214lk rp lk":
    ...
    if message.content == f"{prefix}폴 214ap":
        embed = discord.Embed(title="higaku" , description = "214ap", color=0x009bcf)
        embed.add_field(name="프레임", value="18", inline=True)
        embed.add_field(name="판정", value="중단", inline=False)
        embed.add_field(name="가드시", value="-14)", inline=False)
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884791043424415765/ezgif.com-gif-maker_37.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}와구":
        ...
        embed.add_field(name="가드시", value="+1", inline=False)
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884790759105126461/ezgif.com-gif-maker_29.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}주문하신 음식"  or message. content == f"{prefix}폴 기상어퍼":
        ...
        embed.add_field(name="판정", value="중단", inline=False)
        embed.add_field(name="가드시", value="-14", inline=False)
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884796424036962314/ezgif.com-gif-maker.gif")
        await message.channel.send(embed=embed)

    if message.content == f"{prefix}사응":
        embed = discord.Embed(title="shioh" , description = "기상 lk rp", color=0x009bcf)
        embed.add_field(name="프레임", value="13", inline=True)
        embed.add_field(name="판정", value="중상", inline=False)
        embed.add_field(name="가드시", value="-9", inline=False)
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884790588631826433/ezgif.com-gif-maker_24.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}암운 조이기" or message. content == f"{prefix}킹운 조이기":
        ...
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884790733331136532/ezgif.com-gif-maker_28.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}레붕":
        ...
        embed.set_image(url="https://cdn.discordapp.com/attachments/865482695256440843/884790199970828298/ezgif.com-gif-maker_17.gif")
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}로우 레드":
        embed = discord.Embed(title="rage drive", description = "1rk ak", color=0x009bcf)
        embed.add_field(name="프레임", value="26", inline=True)
        embed.add_field(name="판정", value="하중", inline=False)
        embed.add_field(name="가드시", value="-9", inline=False)
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}로우 1rp":
    ...
    if message.content == f"{prefix}아머킹 푸싱":
        ...
        embed.add_field(name="프레임", value="18", inline=True)
        embed.add_field(name="판정", value="중단(카운터시 6rp lp, 블스(6n23rp)  확정)", inline=False)
        embed.add_field(name="가드시", value="+1", inline=False)
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}아머킹 66rk":
        embed = discord.Embed(title="brawler kick", description = "66rk", color=0x009bcf)
        embed.add_field(name="프레임", value="15", inline=True)
        embed.add_field(name="판정", value="중단(월바운드)", inline=False)
        embed.add_field(name="가드시", value="-14(가드백)", inline=False)
        await message.channel.send(embed=embed)
                        
    if message.content == f"{prefix}래리어트" or message.content == f"{prefix}아머킹 6n23lp":
        embed = discord.Embed(title="shadow lariat", description = "6n23lp", color=0x009bcf)
        embed.add_field(name="프레임", value="15", inline=True)
        embed.add_field(name="판정", value="상단(히트시 6rk 확정)", inline=False)
        embed.add_field(name="가드시", value="+6(가드백)", inline=False)
        await message.channel.send(embed=embed)
                    
    if message.content == f"{prefix}블스" or message.content == f"{prefix}아머킹 6n23rp":
        embed = discord.Embed(title="dark smash", description = "6n23rp", color=0x009bcf)
        embed.add_field(name="프레임", value="14", inline=True)
        embed.add_field(name="판정", value="상단", inline=False)
        embed.add_field(name="가드시", value="-10", inline=False)
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}코브라 클러치" :
    ...
    if message.content == f"{prefix}아머킹 연잡":
        embed = discord.Embed(title="연잡 목록", description = "", color=0x009bcf)
        embed.add_field(name="1", value="코브라 클러치", inline=True)
        embed.add_field(name="2", value="던저버리기 하프 넬슨", inline=True)
        embed.add_field(name="3", value="허리조이기슬리퍼", inline=True)
        embed.add_field(name="4", value="역떨구기", inline=True)
        embed.add_field(name="5", value="트리플 너클", inline=True)
        embed.add_field(name="6", value="스트레치머플러", inline=True)
        embed.add_field(name="7", value="쵸크슬리퍼", inline=True)
        embed.add_field(name="8", value="쓰리카운터펀치", inline=True)
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}브라이언 원투원":
        embed = discord.Embed(title="one two body blow", description = "lp rp lp", color=0x009bcf)
        embed.add_field(name="프레임", value="10", inline=True)
        embed.add_field(name="판정", value="상상중(3타 단독 카운터시 콤보)", inline=False)
        embed.add_field(name="가드시", value="-6", inline=False)
        await message.channel.send(embed=embed)
        
    if message.content == f"{prefix}브라이언 원투쓰리":
        embed = discord.Embed(title="one two low kick", description = "lp rp lk", color=0x009bcf)
        embed.add_field(name="프레임", value="10", inline=True)
        embed.add_field(name="판정", value="상상하(3타 카운터시 214rk 확정)", inline=False)
        embed.add_field(name="가드시", value="-12(3타)", inline=False)
        await message.channel.send(embed=embed)
        
    if message.content == f"{prefix}브라이언 원투포":
        embed = discord.Embed(title="one two high kick", description = "lp rp rk", color=0x009bcf)
        embed.add_field(name="프레임", value="10", inline=True)
        embed.add_field(name="판정", value="상단", inline=False)
        embed.add_field(name="가드시", value="-3", inline=False)
        await message.channel.send(embed=embed)
        
    if message.content == f"{prefix}브라이언 lk lk rp":
        embed = discord.Embed(title="anaconda bite", description = "lk lk rp", color=0x009bcf)
        embed.add_field(name="프레임", value="16", inline=True)
        embed.add_field(name="판정", value="중상상", inline=False)
        embed.add_field(name="가드시", value="-7", inline=False)
        await message.channel.send(embed=embed)
        
    if message.content == f"{prefix}브라이언 lk lk rk":
        embed = discord.Embed(title="anaconda rage", description = "lk lk rk", color=0x009bcf)
        embed.add_field(name="프레임", value="16", inline=True)
        embed.add_field(name="판정", value="중상중", inline=False)
        embed.add_field(name="가드시", value="-12", inline=False)
        await message.channel.send(embed=embed)
        
    if message.content == f"{prefix}브라이언 rk lk rk":
        embed = discord.Embed(title="double spin tomahawk", description = "rk lk rk", color=0x009bcf)
        embed.add_field(name="프레임", value="12", inline=True)
        embed.add_field(name="판정", value="상중중", inline=False)
        embed.add_field(name="가드시", value="-10(2타) ,-12(3타)", inline=False)
        await message.channel.send(embed=embed)
        
    if message.content == f"{prefix}브라이언 ap lp":
        embed = discord.Embed(title="snake bite", description = "ap lp", color=0x009bcf)
        embed.add_field(name="프레임", value="17", inline=True)
        embed.add_field(name="판정", value="중상(호밍기)", inline=False)
        embed.add_field(name="가드시", value="-1", inline=False)
        await message.channel.send(embed=embed)
        
    if message.content == f"{prefix}브라이언 ap rp":
        embed = discord.Embed(title="snake pit", description = "ap rp", color=0x009bcf)
        embed.add_field(name="프레임", value="17", inline=True)
        embed.add_field(name="판정", value="중단(호밍기)", inline=False)
        embed.add_field(name="가드시", value="-14", inline=False)
        await message.channel.send(embed=embed)
        
    if message.content == f"{prefix}브라이언 ak" or message.content == f"{prefix}사이드킥":
        embed = discord.Embed(title="middle side kick", description = "ak", color=0x009bcf)
        embed.add_field(name="프레임", value="18", inline=True)
        embed.add_field(name="판정", value="중단(카운터시 콤보)", inline=False)
        embed.add_field(name="가드시", value="-13(가드백)", inline=False)
        await message.channel.send(embed=embed)
        
    if message.content == f"{prefix}브살문":
        embed = discord.Embed(title="right left to spin kick", description = "6rp lp pk", color=0x009bcf)
        embed.add_field(name="프레임", value="15", inline=True)
        embed.add_field(name="판정", value="중단", inline=False)
        embed.add_field(name="가드시", value="-10(1,2타), -13(3타)", inline=False)
        await message.channel.send(embed=embed)
        
    if message.content == f"{prefix}브라이언 6lk":
        embed = discord.Embed(title="knee strike", description = "6lk", color=0x009bcf)
        embed.add_field(name="프레임", value="16", inline=True)
        embed.add_field(name="판정", value="중단(카운터시 콤보)", inline=False)
        embed.add_field(name="가드시", value="0", inline=False)
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}브라이언 214rp rk":
        embed = discord.Embed(title="smash and mach kick", description = "214rp rk", color=0x009bcf)
        embed.add_field(name="프레임", value="15", inline=True)
        embed.add_field(name="판정", value="중상(히트시 214rk확정)", inline=False)
        embed.add_field(name="가드시", value="-9", inline=False)
        await message.channel.send(embed=embed)
        
    if message.content == f"{prefix}브라이언 하체트":
        embed = discord.Embed(title="hatchet kick", description = "214lk", color=0x009bcf)
        embed.add_field(name="프레임", value="19", inline=True)
        embed.add_field(name="판정", value="중단(카운터시 2ak rp확정)", inline=False)
        embed.add_field(name="가드시", value="-13", inline=False)
        await message.channel.send(embed=embed)
        
    if message.content == f"{prefix}브라이언 214rk":
        embed = discord.Embed(title="kickoff", description = "214rk", color=0x009bcf)
        embed.add_field(name="프레임", value="17", inline=True)
        embed.add_field(name="판정", value="중단", inline=False)
        embed.add_field(name="가드시", value="-12", inline=False)
        await message.channel.send(embed=embed)
        
    if message.content == f"{prefix}브라이언 공참각":
        embed = discord.Embed(title="snake slash", description = "666lk", color=0x009bcf)
        embed.add_field(name="프레임", value="22", inline=True)
        embed.add_field(name="판정", value="중단", inline=False)
        embed.add_field(name="가드시", value="+9", inline=False)
        await message.channel.send(embed=embed)
        
    if message.content == f"{prefix}브라이언 기상어퍼":
        embed = discord.Embed(title="left upper", description = "일어나면서 lp", color=0x009bcf)
        embed.add_field(name="프레임", value="15", inline=True)
        embed.add_field(name="판정", value="중단", inline=False)
        embed.add_field(name="가드시", value="-16(가드백)", inline=False)
        await message.channel.send(embed=embed)
        
    if message.content == f"{prefix}브라이언 기상rp":
        embed = discord.Embed(title="fisherman's slam", description = "일어나면서 rp", color=0x009bcf)
        embed.add_field(name="프레임", value="19", inline=True)
        embed.add_field(name="판정", value="중단(히트후 6rp입력시 콤보)", inline=False)
        embed.add_field(name="가드시", value="-10", inline=False)
        await message.channel.send(embed=embed)
        
    if message.content == f"{prefix}브라이언 기상무릎":
        embed = discord.Embed(title="double high knee kick", description = "일어나면서 lk rk", color=0x009bcf)
        embed.add_field(name="프레임", value="12", inline=True)
        embed.add_field(name="판정", value="중단(1타 카운터시 콤보)", inline=False)
        embed.add_field(name="가드시", value="-10", inline=False)
        await message.channel.send(embed=embed)
        
    if message.content == f"{prefix}스네이크 렘페이지" or message.content == f"{prefix}브라이언 앉아3rp lp":
        embed = discord.Embed(title="snake rampage", description = "몸을 숙이며 3rp lp", color=0x009bcf)
        embed.add_field(name="프레임", value="13", inline=True)
        embed.add_field(name="판정", value="중상", inline=False)
        embed.add_field(name="가드시", value="-8", inline=False)
        await message.channel.send(embed=embed)
        
    if message.content == f"{prefix}노던 크로스" or message.content == f"{prefix}브라이언 앉아3rk":
        embed = discord.Embed(title="northern cross", description = "몸을 숙이며 3rk", color=0x009bcf)
        embed.add_field(name="프레임", value="15", inline=True)
        embed.add_field(name="판정", value="중단", inline=False)
        embed.add_field(name="가드시", value="-10", inline=False)
        await message.channel.send(embed=embed)
    ...
    if message.content == f"{prefix}마레" or message.content == f"{prefix}마스터 레이븐":
