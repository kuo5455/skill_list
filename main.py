...
async def on_message(message):
    ...
    if message.content == f"{prefix}녹티스 기술표":
        ...
        embed.add_field(name="1", value="원투투", inline=False)
        ...
        embed.add_field(name="6", value="ap", inline=False)
        embed.add_field(name="7", value="시프트", inline=False)
        embed.add_field(name="8", value="6lk rp", inline=False)
        embed.add_field(name="9", value="6rk rp", inline=False)
        embed.add_field(name="10", value="중단창", inline=False)
        embed.add_field(name="11", value="롤닷지(6ak)", inline=False)
        embed.add_field(name="12", value="슬라이딩", inline=False)
        embed.add_field(name="13", value="자세 lp", inline=False)
        embed.add_field(name="14", value="파크", inline=False)
        embed.add_field(name="15", value="왼어퍼 투(3lp rp)", inline=False)
        embed.add_field(name="16", value="왼어퍼 포(3lp rk)", inline=False)
        embed.add_field(name="17", value="컷칼", inline=False)
        embed.add_field(name="18", value="진군중단", inline=False)
        embed.add_field(name="19", value="진군상단", inline=False)
        embed.add_field(name="20", value="3ap", inline=False)
        embed.add_field(name="21", value="2lp", inline=False)
        embed.add_field(name="22", value="2rp rp", inline=False)
        embed.add_field(name="23", value="녹력장", inline=False)
        embed.add_field(name="24", value="녹마찰", inline=False)
        embed.add_field(name="25", value="하단창", inline=False)
